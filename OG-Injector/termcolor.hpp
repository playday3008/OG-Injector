...
namespace termcolor
{
    ...
    namespace _internal
    {
        ...
        inline bool is_colorized(std::wostream& stream);
        inline bool is_atty(const std::wostream& stream);
...
#pragma region Wide
    ...
    inline
        std::wostream& colorize(std::wostream& stream)
    {
        stream.iword(_internal::colorize_index()) = 1L;
        return stream;
    }
    ...
    inline
        std::wostream& nocolorize(std::wostream& stream)
    {
        stream.iword(_internal::colorize_index()) = 0L;
        return stream;
    }
    ...
    inline
        std::wostream& dark(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& italic(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& underline(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& blink(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& concealed(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& crossed(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    template <uint8_t code> inline
        std::wostream& color(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
            wchar_t command[12];
            std::_snwprintf(command, sizeof(command), L"\033[38;5;%dm", code);
            stream << command;
#elif defined(TERMCOLOR_USE_WINDOWS_API)
#endif
        }
    ...
    template <uint8_t code> inline
        std::wostream& on_color(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
            wchar_t command[12];
            std::_snwprintf(command, sizeof(command), L"\033[48;5;%dm", code);
            stream << command;
#elif defined(TERMCOLOR_USE_WINDOWS_API)
#endif
        }
...
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
            wchar_t command[20];
            std::_snwprintf(command, sizeof(command), L"\033[38;2;%d;%d;%dm", r, g, b);
            stream << command;
#elif defined(TERMCOLOR_USE_WINDOWS_API)
#endif
        }
...
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
            wchar_t command[20];
            std::_snwprintf(command, sizeof(command), L"\033[48;2;%d;%d;%dm", r, g, b);
            stream << command;
#elif defined(TERMCOLOR_USE_WINDOWS_API)
#endif
        }
    ...
    inline
        std::wostream& grey(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& red(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& green(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& yellow(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& blue(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& magenta(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& cyan(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& white(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& bright_grey(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& bright_red(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& bright_green(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& bright_yellow(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& bright_blue(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& bright_magenta(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& bright_cyan(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& bright_white(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& on_grey(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& on_red(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& on_green(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& on_yellow(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& on_blue(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& on_magenta(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& on_cyan(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& on_white(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& on_bright_grey(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& on_bright_red(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& on_bright_green(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& on_bright_yellow(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& on_bright_blue(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& on_bright_magenta(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& on_bright_cyan(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
    ...
    inline
        std::wostream& on_bright_white(std::wostream& stream)
    {
        if (_internal::is_colorized(stream))
        {
#if defined(TERMCOLOR_USE_ANSI_ESCAPE_SEQUENCES)
...
#pragma region Wide
        ...
        // colorize flag.
        inline
            bool is_colorized(std::wostream& stream)
        {
            return is_atty(stream) || static_cast<bool>(stream.iword(colorize_index()));
        }
        ...
        //! a terminal.
        inline
            bool is_atty(const std::wostream& stream)
        {
            FILE* std_stream = get_standard_stream(stream);
